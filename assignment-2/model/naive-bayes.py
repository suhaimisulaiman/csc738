...
plt.plot(fpr, tpr, marker='.', linewidth=2, label=f'Naive Bayes (AUC = {auc_score:.3f})')
...
plot_decision_boundary(X_train, y_train, classifier, 'Naive Bayes Classifier (Training set)', xlabel='Age', ylabel='Estimated Salary')
plot_decision_boundary(X_test, y_test, classifier, 'Naive Bayes Classifier (Test set)', xlabel='Age', ylabel='Estimated Salary')
